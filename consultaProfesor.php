      ...
      <div class="row">
        <div class="col-sm-12 col-sm-offset-6 myform-cont">
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-6">
                        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                          <br><br><b>Matricula: </b><input type="text" id="campo" name="campo" />
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <?php
              include 'controllers/buscarProfesor.php'; 
              while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
                <tr>
                  ...
                  <td><a href="editarProfesor.php?id=<?php echo $row['idProfesor']; ?>">Editar</a></td>                 
