      ...
      <div class="row">
        <div class="col-sm-12 col-sm-offset-6 myform-cont">
          ...
          <div class="myform-bottom">
            <form class='form-horizontal' role='form'  method="POST" action="controllers/guardarProfesor.php">
                  ...
                  <div class="form-group">
                    <div class="form-row">
                      ...
                      <div class="col-md-3">
                        ...
                        <input class="form-control" id="exampleInputName" name="contrasena" type="password" aria-describedby="nameHelp">
                      </div>
                      <div class="col-md-3">
                        <label for="exampleInputName">Repetir contraseña</label>
                        <input class="form-control" id="exampleInputName" type="password" aria-describedby="nameHelp">
                      </div>                       
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="form-row">
                      ...
                      <div class="col-md-3">
                        ...
                        <input class="form-control" id="exampleInputName" name="direccion" type="text" aria-describedby="nameHelp">
                      </div>                      
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="form-row">
                      ...
                      <div class="col-md-3">
                        ...
                        <input class="form-control" id="exampleInputName" name="correo" type="text" aria-describedby="nameHelp">
                      </div>                      
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="form-row">
                      ...
                      <div class="col-md-3">
                        ...
                        <input class="form-control" id="exampleInputName" name="area" type="text" aria-describedby="nameHelp">
                      </div>                      
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="form-row">
                      ...
                      <div class="col-md-3">
                        <button class='btn-lg btn-info' type='submit'>Registrar profesor</button>
                      </div>                      
                    </div>
                  </div>
